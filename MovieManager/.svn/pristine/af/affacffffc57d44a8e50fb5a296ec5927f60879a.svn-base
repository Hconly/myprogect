...
public class UI_ActionMovie extends JPanel {
	...
	public UI_ActionMovie() {
		...
		List<MovieDto> list = ms.getById(3);
		/**
		 * 遍历电影
		 */
		for (int i = 0; i < list.size(); i++) {
			...
			panel.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					...
					UI_ActionMovie.this.mid=ms.getbyName(panel.getName()).getMid();
