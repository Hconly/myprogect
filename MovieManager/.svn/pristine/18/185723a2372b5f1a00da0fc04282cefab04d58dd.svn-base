...
/**
 *<p>Title:UI_hotMovie</p>
 *<p>Description:热门电影</p>
 * @author 王超
 * @date2018年10月3日上午8:24:34
 */
public class UI_hotMovie extends JPanel {
	...
	public UI_hotMovie() {
		...
		List<MovieDto> list = ms.findByShowName("hot", "1");
		/**
		 * 遍历电影
		 */
		for (int i = 0; i < list.size(); i++) {
			...
			panel.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					...
					UI_hotMovie.this.mid=ms.getbyName(panel.getName()).getMid();
