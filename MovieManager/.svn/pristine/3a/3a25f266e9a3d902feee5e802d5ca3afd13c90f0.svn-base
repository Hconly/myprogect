...
public class UI_SuspenseMovie extends JPanel {
	...
	public UI_SuspenseMovie() {
		...
		List<MovieDto> list = ms.getById(5);
		/**
		 * 遍历电影
		 */
		for (int i = 0; i < list.size(); i++) {
			...
			//System.out.println(list.get(i).getMovie().getM_name());
			...
			panel.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					...
					UI_SuspenseMovie.this.mid=ms.getbyName(panel.getName()).getMid();
