...
public class UI_ThrillerMovie extends JPanel {
	...
	public UI_ThrillerMovie() {
		...
		List<MovieDto> list = ms.getById(4);
		/**
		 * 遍历电影
		 */
		for (int i = 0; i < list.size(); i++) {
			...
			panel.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					...
					UI_ThrillerMovie.this.mid=ms.getbyName(panel.getName()).getMid();
